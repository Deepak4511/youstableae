...
<div class="container">
    <div class="row nav nav-pills wid-more" id="pills-tab" role="tablist" style="padding: 4px;">
        ...
        <div class="col-lg-4 nav-button-plans"><button class="nav-link nav-linked " id="pills-yearly-tab"
                ...
                aria-controls="pills-yearly" aria-selected="false" tabindex="-1">1 Month</button></div>
    </div>
                    ...
                    <div class="position-relative h-100">
                        <div class="upper-card">
                            ...
                            <div class="price-container">
                                <p class="hosting-price indian-host-price"><span class="hin-rs">₹</span>529</p>
                                <p class="hosting-price usa-host-price" style="display: none;"><span
                                        class="hin-rs">$</span>6.60</p>
                            ...
                            <a href="https://www.youstable.com/manage/order.php?currency=2&pid=21&billingcycle=monthly"
                            ...
                            <a href="https://www.youstable.com/manage/order.php?currency=1&pid=21&billingcycle=monthly"
                                class="link-color-black usa-host-price" target="_self"
                                style="display: none;"><button class="btn-yellow exploreplan-btn comp-button-design"
                ...
                <div class="col-md-4 explore-cols">
                    <div class="position-relative h-100">
                        ...
                        <div class="upper-card" style="background: #FEFDFF;">
                            ...
                            <div class="price-container">
                                <p class="hosting-price indian-host-price"><span class="hin-rs">₹</span>659</p>
                                <p class="hosting-price usa-host-price" style="display: none;"><span
                                        class="hin-rs">$</span>8.20</p>
                                <!--<p class="per_month">/month</p>-->
                            </div>
                            ...
                            <a href="https://www.youstable.com/manage/order.php?currency=2&pid=22&billingcycle=monthly"
                            ...
                            <a href="https://www.youstable.com/manage/order.php?currency=1&pid=22&billingcycle=monthly"
                ...
                <div class="col-md-4 explore-cols">
                    <div class="position-relative h-100">
                        <div class="upper-card">
                            ...
                            <div class="price-container">
                                <p class="hosting-price indian-host-price"><span class="hin-rs">₹</span>869</p>
                                <p class="hosting-price usa-host-price" style="display: none;"><span
                                        class="hin-rs">$</span>10.80</p>
                                <!--<p class="per_month">/month</p>-->
                            </div>
                            ...
                            <a href="https://www.youstable.com/manage/order.php?currency=2&pid=23&billingcycle=monthly"
                                class="link-color-black indian-host-price" target="_self"><button
                                    class="btn-yellow exploreplan-btn comp-button-design" type="submit">Get
                                    Started</button></a>

                            <a href="https://www.youstable.com/manage/order.php?currency=1&pid=23&billingcycle=monthly"
                                class="link-color-black usa-host-price" target="_self"
                                style="display: none;"><button class="btn-yellow exploreplan-btn comp-button-design"
                                    type="submit">Get Started</button></a>
                ...
                <div class="col-md-4 explore-cols">
                    <div class="position-relative h-100">
                        <div class="upper-card">
                            ...
                            <div class="price-container">
                                <p class="hosting-price indian-host-price"><span class="hin-rs">₹</span>239</p>
                                <p class="hosting-price usa-host-price" style="display: none;"><span
                                        class="hin-rs">$</span>2.90</p>
                            ...
                            <a href="https://www.youstable.com/manage/order.php?currency=2&pid=21&billingcycle=annually"
                                class="link-color-black indian-host-price" target="_self"><button
                                    class="btn-yellow exploreplan-btn comp-button-design" type="submit">Get
                                    Started</button></a>

                            <a href="https://www.youstable.com/manage/order.php?currency=1&pid=21&billingcycle=annually"
                                class="link-color-black usa-host-price" target="_self"
                                style="display: none;"><button class="btn-yellow exploreplan-btn comp-button-design"
                                    type="submit">Get Started</button></a>
                ...
                <div class="col-md-4 explore-cols">
                    <div class="position-relative h-100">
                        ...
                        <div class="upper-card" style="background: #FEFDFF;">
                            ...
                            <h4 class="hosting-heading">YouProfessional</h4>
                            <div class="price-container">
                                <p class="hosting-price indian-host-price"><span class="hin-rs">₹</span>296</p>
                                <p class="hosting-price usa-host-price" style="display: none;"><span
                                        class="hin-rs">$</span>3.70</p>
                                <!--<p class="per_month">/month</p>-->
                            </div>
                            <!--<p class="regular-price regular-indian-price">Regular price<span class="cross-price"> ₹499/month</span></p>-->
                            <!--<p class="regular-price regular-usa-price">Regular price<span class="cross-price"> $6.3/month</span></p>-->

                            <a href="https://www.youstable.com/manage/order.php?currency=2&pid=22&billingcycle=annually"
                                class="text-white indian-host-price" target="_self"><button
                                    class="btn-purple exploreplan-btn comp-button-design" type="submit">Get
                                    Started</button></a>

                            <a href="https://www.youstable.com/manage/order.php?currency=1&pid=22&billingcycle=annually"
                                class="text-white usa-host-price" target="_self" style="display: none;"><button
                                    class="btn-purple exploreplan-btn comp-button-design" type="submit">Get
                                    Started</button></a>
                            ...
                            <div class="hosting_specification">
                                ...
                                <div class="d-flex gap-2 specifications">
                                    <img src="assets/img/speci-tick.png" class="specification-tick">
                                    <p class="paragraph" data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-custom-class="custom-tooltip"
                                        title="Choose a YouProfessional Web Hosting plan for 1 or 3 years and get a free domain name for the first year! You can select from the following extensions: .com, .xyz, .shop, .cam, .co, .blog, .info, .life, .live, .site, .tech, or .technology.After purchasing your hosting plan, the free domain registration will appear in your control panel. The domain is free for the first year, with renewal charges applying after that. This offer cannot be customized.">
                                        1 Free Domain</p>
                                </div>
                                <div class="d-flex gap-2 specifications">
                                    <img src="assets/img/speci-tick.png" class="specification-tick">
                ...
                <div class="col-md-4 explore-cols">
                    <div class="position-relative h-100">
                        <div class="upper-card">
                            ...
                            <div class="price-container">
                                <p class="hosting-price indian-host-price"><span class="hin-rs">₹</span>389</p>
                                <p class="hosting-price usa-host-price" style="display: none;"><span
                                        class="hin-rs">$</span>4.80</p>
                                <!--<p class="per_month">/month</p>-->
                            </div>
                            <!--<p class="regular-price regular-indian-price">Regular price<span class="cross-price">₹799/month</span></p>-->
                            <!--<p class="regular-price regular-usa-price">Regular price<span class="cross-price">$10.1/month</span></p>-->

                            <a href="https://www.youstable.com/manage/order.php?currency=2&pid=23&billingcycle=annually"
                                class="link-color-black indian-host-price" target="_self"><button
                                    class="btn-yellow exploreplan-btn comp-button-design" type="submit">Get
                                    Started</button></a>

                            <a href="https://www.youstable.com/manage/order.php?currency=1&pid=23&billingcycle=annually"
                                class="link-color-black usa-host-price" target="_self"
                                style="display: none;"><button class="btn-yellow exploreplan-btn comp-button-design"
                                    type="submit">Get Started</button></a>
                            ...
                            <div class="hosting_specification">
                                ...
                                <div class="d-flex gap-2 specifications">
                                    <img src="assets/img/speci-tick.png" class="specification-tick">
                                    <p class="paragraph" data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-custom-class="custom-tooltip"
                                        title="Choose a YouElite Web Hosting plan for 1 or 3 years and get a free domain name for the first year! You can select from the following extensions: .com, .xyz, .shop, .cam, .co, .blog, .info, .life, .live, .site, .tech, or .technology.After purchasing your hosting plan, the free domain registration will appear in your control panel. The domain is free for the first year, with renewal charges applying after that. This offer cannot be customized.">
                                        1 Free Domain</p>
                                </div>
                                <div class="d-flex gap-2 specifications">
                                    <img src="assets/img/speci-tick.png" class="specification-tick">
                ...
                <div class="col-md-4 explore-cols">
                    <div class="position-relative h-100">
                        <div class="upper-card">
                            ...
                            <a href="https://www.youstable.com/manage/order.php?currency=2&pid=21&billingcycle=triennially"
                                class="link-color-black indian-host-price" target="_self"><button
                                    class="btn-yellow exploreplan-btn comp-button-design" type="submit">Get
                                    Started</button></a>

                            <a href="https://www.youstable.com/manage/order.php?currency=1&pid=21&billingcycle=triennially"
                                class="link-color-black usa-host-price" target="_self"
                                style="display: none;"><button class="btn-yellow exploreplan-btn comp-button-design"
                                    type="submit">Get Started</button></a>
                ...
                <div class="col-md-4 explore-cols">
                    <div class="position-relative h-100">
                        ...
                        <div class="upper-card" style="background: #FEFDFF;">
                            ...
                            <h4 class="hosting-heading">YouProfessional</h4>
                            <div class="price-container">
                                <p class="hosting-price indian-host-price"><span class="hin-rs">₹</span>197</p>
                                <p class="hosting-price usa-host-price" style="display: none;"><span
                                        class="hin-rs">$</span>2.40</p>
                                <!--<p class="per_month">/month</p>-->
                            </div>
                            <!--<p class="regular-price regular-indian-price">Regular price<span class="cross-price"> ₹499/month</span></p>-->
                            <!--<p class="regular-price regular-usa-price">Regular price<span class="cross-price"> $6.3/month</span></p>-->

                            <a href="https://www.youstable.com/manage/order.php?currency=2&pid=22&billingcycle=triennially"
                                class="text-white indian-host-price" target="_self"><button
                                    class="btn-purple exploreplan-btn comp-button-design" type="submit">Get
                                    Started</button></a>

                            <a href="https://www.youstable.com/manage/order.php?currency=1&pid=22&billingcycle=triennially"
                                class="text-white usa-host-price" target="_self" style="display: none;"><button
                                    class="btn-purple exploreplan-btn comp-button-design" type="submit">Get
                                    Started</button></a>
                ...
                <div class="col-md-4 explore-cols">
                    <div class="position-relative h-100">
                        <div class="upper-card">
                            ...
                            <a href="https://www.youstable.com/manage/order.php?currency=1&pid=23&billingcycle=triennially"
                                class="link-color-black usa-host-price" target="_self"
                                style="display: none;"><button class="btn-yellow exploreplan-btn comp-button-design"
                                    type="submit">Get Started</button></a>
