                ...
                <div class="table-container">
                    ...
                    <div class="compare-section">
                        ...
                        <div class="table-striped d-flex">
                            ...
                            <div class="table-option">cPanel</div>
                            <div class="table-option">cPanel</div>
                            <div class="table-option">cPanel</div>
                        </div>
                        <div class="table-striped style-strip d-flex">
                        ...
                        <div class="table-striped d-flex">
                            <div class="table-option">Free Drag and Drop Sitebuilder</div>
                        ...
                        <div class="table-striped d-flex">
                            ...
                            <div class="table-option">1MB</div>
                            <div class="table-option">3GB</div>
                            <div class="table-option">5GB</div>
                        </div>
                        <div class="table-striped style-strip d-flex">
                        ...
                        <div class="bottom-section">
                            <div class="d-flex">
                                ...
                                <div class="bottom-option">
                                    ...
                                    <div class="price-container share-set-pd">
                                        <p class="hosting-price indian-host-price indian-host-prices"><span
                                                class="hin-rs">₹</span>159</p>
                                        <p class="hosting-price usa-host-price usa-host-prices" style="display: none;"><span
                                                class="hin-rs">$</span>1.90</p><p class="per_month comp-table-year">/mo*</p>
                                    </div>
                                    <a href="https://www.youstable.com/manage/cart.php?currency=2&pid=21&billingcycle=triennially"
                                    ...
                                    <a href="https://www.youstable.com/manage/cart.php?currency=1&pid=21&billingcycle=triennially"
                                ...
                                <div class="bottom-option">
                                    <div class="price-container share-set-pd">
                                        <p class="hosting-price indian-host-price indian-host-prices"><span
                                                class="hin-rs">₹</span>197</p>
                                        <p class="hosting-price usa-host-price usa-host-prices" style="display: none;"><span
                                                class="hin-rs">$</span>2.40</p><p class="per_month comp-table-year">/mo*</p>
                                    </div>
                                    <a href="https://www.youstable.com/manage/cart.php?currency=2&pid=22&billingcycle=triennially"
                                    ...
                                    <a href="https://www.youstable.com/manage/cart.php?currency=1&pid=22&billingcycle=triennially"
                                ...
                                <div class="bottom-option">
                                    <div class="price-container share-set-pd">
                                        <p class="hosting-price indian-host-price indian-host-prices"><span
                                                class="hin-rs">₹</span>259</p>
                                        <p class="hosting-price usa-host-price usa-host-prices" style="display: none;"><span
                                                class="hin-rs">$</span>3.20</p><p class="per_month comp-table-year">/mo*</p>
                                    </div>
                                    <a href="https://www.youstable.com/manage/cart.php?currency=2&pid=23&billingcycle=triennially"
                                        class="link-color-black indian-host-price" target="_self"><button
                                            class="btn-yellow exploreplan-btn comp-button-design" type="submit">Get Started </button></a>

                                    <a href="https://www.youstable.com/manage/cart.php?currency=1&pid=23&billingcycle=triennially"
                                        class="link-color-black usa-host-price" target="_self" style="display: none;"><button
                                            class="btn-yellow exploreplan-btn comp-button-design" type="submit">Get Started </button></a>
                                </div>
                            </div>
