...
<script>
  window.addEventListener('scroll', () => {
    const stickySection = document.querySelector('.table-comparison');
    const otherSection = document.querySelector('.other');

    const stickySectionRect = stickySection.getBoundingClientRect();
    const otherSectionRect = otherSection.getBoundingClientRect();

    if (otherSectionRect.top <= 0) {
